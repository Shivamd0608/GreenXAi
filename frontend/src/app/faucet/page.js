...
import { Droplets, Wallet, Clock, CheckCircle, AlertCircle, ExternalLink, Loader2 } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl font-bold text-white mb-4">MockUSDC Faucet</h1>
          ...
          <div className="bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8 shadow-2xl">
            {!isConnected ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-400 mb-6">Connect your wallet to claim free test tokens</p>
                <button
              ...
              <div className="space-y-6">
                ...
                <div className="bg-slate-900/50 rounded-xl p-4 border border-slate-700/50">
                  ...
                  <div className="flex items-center justify-between mt-2">
                    ...
                    <span className="text-white">{parseFloat(balance).toFixed(4)} MNT</span>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 rounded-xl p-6 border border-emerald-500/20">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-gray-400 text-sm">Your mUSDC Balance</p>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-slate-900/50 rounded-xl p-4 border border-slate-700/50">
                      ...
                      <p className="text-xl font-semibold text-white mt-1">
                        {parseFloat(faucetInfo.faucetAmount).toLocaleString()} mUSDC
                      </p>
                    </div>
                    <div className="bg-slate-900/50 rounded-xl p-4 border border-slate-700/50">
                      ...
                      <p className="text-xl font-semibold text-white mt-1 flex items-center gap-2">
                        ...
                        {faucetInfo.canClaim ? 'Ready!' : formatWaitTime(faucetInfo.waitTime)}
                      </p>
                    </div>
                  </div>
                )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
            <div className="bg-slate-800/30 backdrop-blur border border-slate-700/50 rounded-xl p-4">
              ...
              <p className="text-sm text-gray-400">Claim test mUSDC tokens every 2 minutes for free</p>
            </div>
            <div className="bg-slate-800/30 backdrop-blur border border-slate-700/50 rounded-xl p-4">
              <h3 className="font-semibold text-white mb-2">🔄 Use in AMM</h3>
              <p className="text-sm text-gray-400">Add liquidity or swap tokens on GreenXchange</p>
            </div>
            <div className="bg-slate-800/30 backdrop-blur border border-slate-700/50 rounded-xl p-4">
              <h3 className="font-semibold text-white mb-2">📊 Trade Credits</h3>
              <p className="text-sm text-gray-400">Use mUSDC to buy wrapped green credits</p>
            </div>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-500 text-sm">
              Connected to <span className="text-cyan-400">{CHAIN_CONFIG.chainName}</span>
            </p>
          </div>
        </div>
      </div>
