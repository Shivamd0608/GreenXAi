  ...
  const coreFeatures = [
    {
      ...
      description: "Convert verified environmental projects into ERC-1155 tokens on Mantle L2",
      link: "/onboarding",
    ...
    },
    {
      ...
      description: "Make your credits DeFi compatible by wrapping them for use in liquidity pools",
      link: "/green-credits",
    ...
    },
    {
      emoji: "🤖",
      title: "AMM Trading",
      description: "Instant swaps with Uniswap V2 style pools. Earn 0.3% fees as liquidity provider",
      link: "/trade/amm",
    ...
    },
    {
      ...
      description: "Place limit orders with USDC settlement. Platform fee: 0.25%",
      link: "/marketplace",
  ...
  const mantleBenefits = [
    {
      ...
      description: "Mantle L2 reduces transaction costs from $50-200 to $0.01-0.10 per trade",
      icon: "💰"
    },
    {
      title: "Instant Settlement",
      description: "~1 second transaction finality with Ethereum-level security",
      icon: "⚡"
    },
    {
      title: "Global Accessibility",
      description: "Low fees enable participation from developing countries and small projects",
      icon: "🌍"
    },
    {
      title: "Full DeFi Compatibility",
      description: "EVM compatible with seamless integration to other DeFi protocols",
      icon: "🔗"
    }
  ];
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black border border-gray-700 rounded-2xl shadow-2xl max-w-md w-full overflow-hidden">
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className="text-lg font-semibold text-white group-hover:text-emerald-300">AMM Swap</h4>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className="text-lg font-semibold text-white group-hover:text-blue-300">Orderbook Trading</h4>
                      <p className="text-gray-400 mt-2 text-sm">
              ...
              <div className="mt-6 p-4 bg-gray-800/50 rounded-lg">
                <h4 className="font-semibold text-gray-300 mb-2 text-sm">Quick Tip</h4>
                <p className="text-sm text-gray-400">
                  Use AMM for quick sales at market price. Use Orderbook to set your own price.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black border border-gray-700 rounded-2xl shadow-2xl max-w-4xl w-full overflow-hidden">
            <div className="p-6">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-xl font-bold text-white">Start Trading Green Credits</h3>
                <button 
                  onClick={() => setShowTradingModal(false)}
                  className="text-gray-400 hover:text-gray-200 transition-colors"
                >
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div>
                  <div className="mb-4">
                    <h4 className="text-lg font-semibold text-emerald-400 mb-2">Buy Credits</h4>
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div>
                          <h5 className="font-semibold text-white group-hover:text-emerald-300">AMM Trading</h5>
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div>
                          <h5 className="font-semibold text-white group-hover:text-blue-300">Orderbook Trading</h5>
                          <p className="text-gray-400 mt-1 text-xs">
                ...
                <div>
                  <div className="mb-4">
                    <h4 className="text-lg font-semibold text-red-400 mb-2">Sell Credits</h4>
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div>
                          <h5 className="font-semibold text-white group-hover:text-purple-300">Register & Mint New</h5>
                          <p className="text-gray-400 mt-1 text-xs">
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div>
                          <h5 className="font-semibold text-white group-hover:text-orange-300">Sell Existing Tokens</h5>
                          <p className="text-gray-400 mt-1 text-xs">
              ...
              <div className="mt-6 p-4 bg-gray-800/50 rounded-lg">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <h5 className="font-semibold text-emerald-400 mb-1">Buying Tips</h5>
                    <p className="text-gray-400 text-xs">Use AMM for quick purchases, Orderbook for large orders</p>
                  </div>
                  <div>
                    <h5 className="font-semibold text-red-400 mb-1">Selling Tips</h5>
                    <p className="text-gray-400 text-xs">New projects need verification, existing tokens sell instantly</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 text-center">
                <p className="text-sm text-gray-500">
                  Connected as: <span className="font-mono text-gray-300">{account?.slice(0, 6)}...{account?.slice(-4)}</span>
                </p>
              </div>
            </div>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-12">
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              Green<span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400">Xchange</span>
            </h1>
            
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Decentralized Exchange for Tokenized Environmental Credits
              <br />
              <span className="text-emerald-400">Built on Mantle L2 for ultra-low fees</span>
            </p>
            ...
            <div className="inline-flex items-center space-x-4 bg-gray-800/50 px-6 py-3 rounded-xl border border-gray-700">
              ...
              <div className="h-4 w-px bg-gray-600"></div>
              <span className="text-sm text-emerald-400">Gas: ~$0.01 per transaction</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-3xl mx-auto">
              GreenXchange is built on Mantle Sepolia L2 for maximum efficiency and accessibility
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {mantleBenefits.map((benefit, index) => (
              <div key={index} className="bg-gray-900/50 rounded-xl p-6 border border-gray-700 hover:border-cyan-500/50 transition-all duration-300">
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-3xl mx-auto">
              A full-fledged decentralized exchange specifically designed for environmental credits
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {coreFeatures.map((feature, index) => (
              <div key={index} className="bg-gradient-to-br from-gray-900 to-black rounded-xl p-8 border border-gray-700 hover:border-emerald-500/50 transition-all duration-300 group">
      ...
      <section className="py-16 px-4 bg-gray-800/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-3xl mx-auto">
              Trade multiple types of environmental assets with transparent verification
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {creditTypes.map((credit, index) => (
              <div key={index} className={`${credit.color} rounded-xl p-6 border border-gray-700 hover:scale-105 transition-all duration-300`}>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Choose Your <span className="text-emerald-400">Trading Style</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-gray-900 to-black rounded-xl p-8 border border-emerald-500/30 hover:border-emerald-500/50 transition-all duration-300">
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold mb-2 text-emerald-400">AMM Trading</h3>
            ...
            <div className="bg-gradient-to-br from-gray-900 to-black rounded-xl p-8 border border-cyan-500/30 hover:border-cyan-500/50 transition-all duration-300">
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold mb-2 text-cyan-400">Orderbook Trading</h3>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Trade <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400">Green Credits</span>?
          </h2>
          <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
            Join the revolution in sustainable finance. Tokenize, trade, and make an impact with ultra-low fees on Mantle L2.
          </p>
          ...
          <div className="mt-8 text-sm text-gray-500">
            <p>Need test tokens? Visit <a href="https://faucet.sepolia.mantle.xyz" className="text-cyan-400 hover:text-cyan-300">Mantle Sepolia Faucet</a></p>
          </div>
        </div>
      </section>
